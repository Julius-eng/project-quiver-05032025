...
[Open Interactive BOM](./assets/Quiver_PT3_Main_PCB_V0.1_ibom.html)

![Interactive BOM screenshot](./assets/main-pcb/bom.png)
...
![Additional devices mounting positions](./assets/main-pcb/Devices.png)
