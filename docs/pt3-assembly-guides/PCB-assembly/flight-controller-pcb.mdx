...
# Flight Controller PCB Assembly Manual
...
[Open Interactive BOM](./assets/Quiver_PT3_FC_PCB_V0.1_ibom.html)

![Interactive BOM screenshot](./assets/fc-pcb/bom.png)
...
![Top side of PCB](./assets/fc-pcb/PCB_1.png)

### View on the bottom side of this PCB (this side will connect to the PT3 Main PCB):

![Bottom side of PCB](./assets/fc-pcb/PCB_2.png)
